...
@router.post("/global", responses=generate_error_response(GlobalConfigAlreadyExists))
...
@router.patch("/global", responses=generate_error_response(ConfigNotFound, "global configuration"))
...
@router.post("/reverse-proxy", responses=generate_error_response(VirtualHostNameAlreadyExists))
...
@router.patch("/reverse-proxy", responses=generate_error_response(ConfigNotFound, "reverse proxy configuration"))
...
@router.delete("/reverse-proxy", responses=generate_error_response(ConfigNotFound, "reverse proxy configuration"))
...
@router.post("/load-balancer", responses=generate_error_response(VirtualHostNameAlreadyExists))
...
@router.patch("/load-balancer", responses=generate_error_response(ConfigNotFound, "load balancer configuration"))
...
@router.delete("/load-balancer", responses=generate_error_response(ConfigNotFound, "load balancer configuration"))
...
@router.post("/static-file", responses=generate_error_response(VirtualHostNameAlreadyExists))
...
@router.patch("/static-file", responses=generate_error_response(ConfigNotFound, "static file configuration"))
...
@router.delete("/static-file", responses=generate_error_response(ConfigNotFound, "static file configuration"))
